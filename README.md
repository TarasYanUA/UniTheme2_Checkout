...
Чтобы запустить авто-тесты на мобильном устройстве нужно:
1. Перейти в класс hooks.DriverHooks и закоментировать @Before для ПК, а @Before для мобильного раскоментировать;
2. Перейти в класс CucumberTestRunner и раскоментировать tags для мобильного устройства.