@MV140
Feature:(MV) Чекаут со способом доставки и способом оплаты в виде Обычного списка + Неавторизованный пользователь
  ...
  Scenario:(MV) Чекаут со способом доставки и способом оплаты в виде Обычного списка + Неавторизованный пользователь
    ...
    And Выбираем способ доставки "Обсудить с менеджером" для первого продавца из "обычного" списка (скриншот "@110")
    And Выбираем способ "доставки" "Самовывоз" из обычного списка (скриншот "@140")
    ...
    Then Завершаем оформление заказа и проверяем, что заказ оформлен успешно (скриншот "@140")