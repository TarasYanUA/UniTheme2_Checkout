@20
Feature: Чекаут со способом доставки и способом оплаты в виде выпадающего списка + Неавторизованный пользователь
  ...
  Scenario: Чекаут со способом доставки и способом оплаты в виде выпадающего списка + Неавторизованный пользователь
